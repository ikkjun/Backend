...
//        com.slowcampus.ch2.Car car  = (com.slowcampus.ch2.Car) ac.getBean("car"); // 이름으로 빈 검색
//        com.slowcampus.ch2.Car car2 = (com.slowcampus.ch2.Car) ac.getBean(com.slowcampus.ch2.Car.class);   // 타입으로 빈 검색
...
//        System.out.println("ac.isTypeMatch(\"car\", Car.class) = " + ac.isTypeMatch("car", com.slowcampus.ch2.Car.class)); // "car"라는 이름의 빈의 타입이 Car인지 확인
